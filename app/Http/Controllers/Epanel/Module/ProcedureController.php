...
{
    public function __construct(Procedure $data) 
    {
    ...
    public function index(Request $request) 
    {
        ...
        # Tampilkan View
        return view('epanel.modules.procedure.index', compact('data'));
    }

    public function create() 
    {
        return view('epanel.modules.procedure.create');
    }
    ...
    public function store(Request $request) 
    {
        ...
        if($request->hasFile('icon')):
            $direktori = public_path().'/upload/procedure/';
        ...
        notify()->flash('Data Procedure berhasil ditambah!', 'success');
        return redirect(route('epanel.procedure.index'));
    }
    ...
    public function edit(Request $request, $id) 
    {
        ...
        return view('epanel.modules.procedure.edit', compact('edit'));
    }
    ...
    public function update(Request $request, $id) 
    {
        ...
        notify()->flash('Data Procedure berhasil diubah!', 'success');
        return redirect(route('epanel.procedure.index'));
    }
