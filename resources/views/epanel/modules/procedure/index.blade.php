...
@section('content')
    @if(!$data->count())
        ...
        @include('epanel.layouts.components.kosong', [
            ...
            'judul' => 'Module Procedure',
            'subjudul' => 'Sepertinya Anda belum memiliki Procedure.', 
            'tambah' => route('epanel.procedure.create')
        ])

    @else
        
        {!! Form::open(['method' => 'delete', 'route' => ['epanel.procedure.destroy', 'hapus-all'], 'id' => 'submit-all']) !!}
                                ...
                                <td style="white-space: nowrap; width: 1%;">
                                    <div class="btn-toolbar">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('epanel.procedure.edit', $temp->id) }}" role="button" 
