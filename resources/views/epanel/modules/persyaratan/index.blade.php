...
@section('content')
    @if(!$data->count())
        ...
        @include('epanel.layouts.components.kosong', [
            ...
            'judul' => 'Module Persyaratan',
            'subjudul' => 'Sepertinya Anda belum memiliki Persyaratan.', 
            'tambah' => route('epanel.persyaratan.create')
        ])

    @else
        
        {!! Form::open(['method' => 'delete', 'route' => ['epanel.persyaratan.destroy', 'hapus-all'], 'id' => 'submit-all']) !!}
                                ...
                                <td style="white-space: nowrap; width: 1%;">
                                    <div class="btn-toolbar">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('epanel.persyaratan.edit', $temp->id) }}" role="button" 
