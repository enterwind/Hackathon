...
@section('content')
    @if(!$data->count())
        ...
        @include('epanel.layouts.components.kosong', [
            ...
            'judul' => 'Module Sponsor',
            'subjudul' => 'Sepertinya Anda belum memiliki Sponsor.', 
            'tambah' => route('epanel.sponsor.create')
        ])

    @else
        
        {!! Form::open(['method' => 'delete', 'route' => ['epanel.sponsor.destroy', 'hapus-all'], 'id' => 'submit-all']) !!}
                    ...
                    <table id="datatable" class="display table table-striped" cellspacing="0" width="100%">
                        ...
                        @foreach($data as $i => $temp)
                            <tr>
                                ...
                                <td>
                                    <a href="{!! $temp->url !!}" target="_blank">{!! $temp->url !!}</a>
                                </td>
                                <td>
                                    {!! pilihKerjaSama($temp->jenis) !!}
                                </td>
                                <td style="white-space: nowrap; width: 1%;">
                                    <div class="btn-toolbar">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('epanel.sponsor.edit', $temp->id) }}" role="button" 
