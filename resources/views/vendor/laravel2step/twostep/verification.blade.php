...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel verification-form-panel" style="background: #e0e0e069;border-radius: 20px;margin-top: -10px">
                <div class="panel-heading text-center" id="verification_status_title">
                    <h2 style="font-weight: 800;font-size: 3.5rem;margin-bottom: 10px;font-family: 'Lato', sans-serif;
                        text-shadow:2px 2px 3px rgba(255, 255, 255, 0.3);color:#65bc6a">
                        {{ trans('laravel2step::laravel-verification.title') }}
                    </h2>
                    <h4 class="text-center" style="line-height: 25px">
